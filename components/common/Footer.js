...
import NewsModal from '../signupModal/NewsletterModal';
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-4">
            ...
            <div className="position-relative">
              ...
              />
              <button onClick={handleOpen} data-analyze="newsletter" className="bg-transparent position-absolute right-0 top-50 translateY--50 pr-2 h-48">
